...
export const useGetAllCollectionReleases = (options: object = {}) => {
  const getAllCollectionReleases =
  ...
  return useQuery(["discogsAllCollectionResources"], getAllCollectionReleases, {
    enabled: false,
    ...options,
  });
};
